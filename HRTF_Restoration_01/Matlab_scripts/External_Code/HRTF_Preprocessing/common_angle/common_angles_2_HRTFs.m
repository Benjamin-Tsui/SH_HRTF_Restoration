...
if range < 180
    ...
    % to azimuth angle (made it a bit larger to be safe, uses to limit azimuth differences)
    % est_range_remain covers the remain data on the top and bottom (uses on elevation)
else
    est_range = 360;
    est_range_remain = 0;
